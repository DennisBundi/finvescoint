            ...
            {related.map((service) => (
              <motion.div key={service.slug} variants={fadeUp}>
                <Link
                  ...
                  className="group flex flex-col h-full p-8 md:p-10 border border-border hover:border-gold/50 transition-all duration-300 relative overflow-hidden"
                >
                  <div
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="font-serif text-2xl md:text-3xl text-offwhite mb-3 group-hover:text-gold transition-colors duration-300">
                      {service.title}
                    </h3>
                    <p className="text-muted text-sm leading-relaxed mb-8">
                      {service.tagline}
                    </p>
                    <div className="flex items-center gap-2 text-gold text-xs tracking-widest uppercase group-hover:gap-4 transition-all duration-300">
